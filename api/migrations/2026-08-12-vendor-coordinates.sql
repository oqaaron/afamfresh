-- =============================================================
-- Vendor coordinates, for surplus delivery pricing
-- =============================================================
-- A surplus load is collected from the VENDOR and driven to the customer, but
-- vendors carry only a free-text `location` ("Nakawa market", "near the
-- stage"). There is nothing to measure a distance from, so the surplus
...
-- includes/surplus_delivery_fee.php can charge for the real journey.
--
...
-- surplus_orders.delivery_fee_breakdown already exists and holds JSON; this is
